...
abstract class AbsAdapter<T, H extends AdapterHelper> extends android.widget.BaseAdapter implements DataIO<T> {

    protected final int layoutResIds[];
    protected final ArrayList<T> data;

    public AbsAdapter(int... layoutResIds) {
        this(null, layoutResIds);
    }

    public AbsAdapter(List<T> data, int... layoutResIds) {
