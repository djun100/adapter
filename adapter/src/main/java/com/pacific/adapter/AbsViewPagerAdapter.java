...
abstract class AbsViewPagerAdapter<T, H extends PagerAdapterHelper> extends PagerAdapter implements DataIO<T> {
    ...
    public AbsViewPagerAdapter(Context context, int layoutResId) {
        this(context, null, layoutResId);
    }

    public AbsViewPagerAdapter(Context context, List<T> data, int layoutResId) {
